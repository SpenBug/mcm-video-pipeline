...
| 档 | 文件 | 一句话定位 | 视觉气质 | 时长 |
|---|---|---|---|---|
| **T7** | `templates/T7-纸感笔记.md` | 米白纸 + 装订线 + 荧光笔 + **楷体批注** | 朴素、亲和、像学习笔记 | 150–240s |
| **T8** | `templates/T8-数据仪表盘.md` | 环形仪表 + **等宽数字** + 逐段绘制趋势线 | 精密、科技、像监控大屏 | 120–200s |
...
![T7 纸感笔记](assets/preview/T7-纸感笔记.png)

**T8 · 数据仪表盘** — 所有数字用等宽字体，才有「仪表读数」的感觉

![T8 数据仪表盘](assets/preview/T8-数据仪表盘.png)

**T9 · 杂志排版** — 全片只有一个强调色（正红），靠排版撑层次

![T9 杂志排版](assets/preview/T9-杂志排版.png)
...
flowchart TD
    ...
    Q1 -->|"核心是数字"| T8["T8 数据仪表盘档<br/>120–200s · 环形仪表"]
